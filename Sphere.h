...
void normalize(GLfloat *a);
	...
	struct VBOSphere
	{
		...
		VBOSphere(double red, double green, double blue, double alpha, double radius, int numSubdivisions);
		VBOSphere();

		void draw();
		void init(double red, double green, double blue, double alpha, double radius, int numSubdivisions);
